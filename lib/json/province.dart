...
List<String> genListProvinces() {
  List<String> listProvince = [];
  provincesData.forEach((element) {
    listProvince.add(element["name"]
        .toString()
...
List<String> genListDistricts(String province) {
  List<String> listDistrict = [];
  provincesData.forEach((element) {
    if (element["name"].toString().contains(province)) {
      List districts = element["districts"] as List;
      districts.forEach((element) {
        listDistrict.add(element["name"] as String);
      });
    }
  });
...
String getDistrict(List<String> districtsData, String district) {
  for (String i in districtsData) {
    if (i.contains(district)) {
      return i;
    }
  }
